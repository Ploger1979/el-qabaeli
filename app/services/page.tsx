    ...
    >
      ...
      <div className="bg-black/60 min-h-screen px-4 sm:px-6 py-16 flex flex-col items-center text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl sm:text-3xl leading-relaxed text-white">
            هدفنا بسيط وواضح
            <br />
        ...
        <section className="mb-12">
          <p className="text-xl sm:text-2xl lg:text-4xl text-white max-w-3xl leading-relaxed">
            نقدم مجموعة متكاملة من الخدمات التي تجعل سيارتك مميزة
          </p>
        </section>

        {/* قائمة الخدمات */}
        <section className="bg-white/90 text-black rounded-xl p-6 sm:p-8 w-full max-w-4xl shadow-lg animate-fade-in-up">
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#20438a] mb-6 text-right">
            خدماتنا تشمل:
          </h3>
          <ul className="space-y-4 text-lg sm:text-2xl leading-loose text-right">
