export const metadata = {
  title: "من نحن – القبايلي لخدمات السيارات في ليبيا",
  description:
    "تعرف على تاريخ القبايلي منذ عام 1987 في سوق التوانسة، فريق متخصص في خدمات السيارات، تغليف المقاعد، التكييف، الأقفال والمزيد.",
  keywords: [
    "من نحن",
    "القبايلي",
    "محلات سيارات بنغازي",
  ...
  openGraph: {
    title: "من نحن – القبايلي",
    description:
      "فريق القبايلي يعمل بخبرة منذ عام 1987 لتقديم أفضل خدمات السيارات في ليبيا – الجودة والثقة في كل تفصيل.",
    url: "https://el-qabaeli.com/about",
    siteName: "القبايلي",
    images: [
      {
        url: "/images/opengraph-about.jpg", // ✳️ غير الصورة حسب المتاح
        width: 1200,
        height: 630,
        alt: "القبايلي – من نحن",
      },
