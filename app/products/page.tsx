export default function ProductsPage() {
  return (
    <main
      dir="rtl"
      className="bg-white text-black font-cairo min-h-screen px-4 sm:px-6 py-10"
    >
      {/* العنوان الرئيسي */}
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
        {/* منتج 1 */}
        <div className="bg-white rounded-lg shadow-md p-4 transition-all duration-300 border hover:shadow-lg hover:scale-[1.02] hover:border-[#000080]">
          <img
            src="/images/motagat/flamingo_foam.jpg"
            alt="منظف فلامنغو"
            className="rounded mb-4 w-full h-auto object-cover"
          />
          <h2 className="text-xl font-bold mb-2 text-pink-700 leading-snug">
            منظف رغوي متعدد الاستخدام
            <br />
            <span className="text-[#20438a]">Flamingo 650ML</span>
          </h2>
          <p className="text-gray-700 text-base mb-3 leading-relaxed">
            منظف فوم فعّال ومثالي للسيارات، القوارب، والمنازل. يعيد اللون
            والمظهر الطبيعي بفضل رغوته العميقة.
          </p>
          ...
          <p className="text-lg font-bold text-red-600">السعر: 25 د.ل</p>
        </div>

        {/* منتج 2 */}
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          <img
          ...
          <p className="text-md text-gray-600 mb-4 leading-relaxed">
            ...
            <br />
            • لمعان ناعم ومتساوٍ بفضل معززات اللمعان الخاصة.
            <br />
            • يغذي الإطار ويحافظ على مظهره الأسود الطبيعي.
            <br />• فوهة دقيقة لتقليل الرش الزائد وتحقيق توزيع متوازن.
          </p>
          ...
          <p className="text-md text-gray-600 mb-4 leading-relaxed">
            ...
            <br />
            • رش من مسافة 8 إلى 12 بوصة على إطار نظيف وجاف.
            <br />
            • اتركه يجف لمدة 5 دقائق على الأقل – لا تمسح.
            <br />• أي خطوط أو قطرات ستختفي تلقائيًا، وتترك لمعانًا رائعًا.
          </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            <span className="text-2xl font-bold text-yellow-500">
              ...
              <br />
              <span className="flex items-center gap-2 text-2xl font-bold text-yellow-500">
                بلمسة واحدة!
                <img
                  src="/images/motagat/pinklike_116094.ico"
                  alt="Thumb icon"
                  className="w-6 h-6"
                />
              </span>
          ...
          <p className="text-md text-gray-600 mb-4 leading-relaxed">
            ...
            <br />
            • رش مباشرة داخل فتحات التكييف أثناء تشغيل المروحة فقط.
            <br />
            • اترك المكيف يعمل لمدة 5–10 دقائق بدون ركاب داخل السيارة.
            <br />• استمتع بأداء تبريد أقوى وهواء أنقى.
          </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            احصل على طبلون لامع بمظهر أنيق مع ملمّع <strong>Flamingo</strong>{" "}
            المصمم لحماية وتنظيف أسطح السيارة الداخلية. مناسب للطبلون،
            البلاستيك، الجلد، المطاط، والڤينيل – ويمنح مظهراً "رطباً" يدوم
            طويلاً.
            <br />
            <strong>متوفر بـ 6 روائح رائعة:</strong>
            <div className="mt-3 space-y-1 text-lg">
              <span className="text-pink-600">🍓 فراولة</span>
              <br />
              <span className="text-yellow-500">🍋 ليمون</span>
              <br />
              <span className="text-purple-600">🌸 ياسمين</span>
              <br />
              <span className="text-orange-500">🍑 خوخ</span>
              <br />
              <span className="text-gray-700">🪵 عود</span>
              <br />
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            منظف حاقن الوقود من <strong>Flamingo</strong> هو الحل الأمثل لتحسين
            كفاءة المحرك وتقليل استهلاك الوقود. تركيبته المتقدمة تعمل على إزالة
            الرواسب ومنع التآكل وتقليل الاحتكاك، مما يطيل عمر الحاقن ويحسّن أداء
            السيارة بشكل ملحوظ.
          </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-4">
            ...
            وقوية بنسبة سطوع تصل إلى <strong>300%</strong> مقارنةً بالمصابيح
            التقليدية. مثالية لتحسين الرؤية الليلية، مع تصميم متين ومروحة تبريد
            فعالة لضمان ثبات الإضاءة وحماية ضد السخونة.
          </p>
          ...
          <p className="text-md text-gray-600 mb-4 leading-relaxed">
            ...
            <br />
            • الألوان المتوفرة: أصفر، أبيض، أزرق
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          ...
          <p className="text-md text-gray-600 mb-4 leading-relaxed">
            <strong>المميزات:</strong>
            <br />
            • خامة قماشية عالية الجودة مع لمسة جلدية
            <br />
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          <img
            src="/images/motagat/copper-leather-seat-cover.jpg"
        ...
        <div className="bg-white rounded-lg shadow-md p-4 hover:scale-105 transition-transform duration-300 border hover:border-[#000080]">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            يأتي بتصميم أنيق وعملي، قابل للطي ومناسب لجميع الهواتف الذكية.
          </p>
